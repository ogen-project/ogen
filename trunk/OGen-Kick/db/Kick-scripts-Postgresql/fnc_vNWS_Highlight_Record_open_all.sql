CREATE OR REPLACE FUNCTION "fnc_vNWS_Highlight_Record_open_all"("IDApplication_search_" integer)
...
$BODY$
  ...
  COST 100
  ROWS 1000;
ALTER FUNCTION "fnc_vNWS_Highlight_Record_open_all"(integer) OWNER TO postgres;
