CREATE OR REPLACE FUNCTION "fnc_vNWS_Source_Record_open_Approved"("IDApplication_search_" integer)
...
$BODY$
  ...
  COST 100
  ROWS 1000;
ALTER FUNCTION "fnc_vNWS_Source_Record_open_Approved"(integer) OWNER TO postgres;
