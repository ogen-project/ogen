<%@ Page 
	...
	CodeBehind="NWS-NewsTag-list.aspx.cs" 
	Inherits="OGen.NTier.Kick.presentationlayer.weblayer.NWS_NewsTag_list" 
		...
		<ItemTemplate>
				<tr>
					<td class="label_small nowrap" style="width: 100%;">
						<a 
							href='NWS-NewsTag.aspx?IDTag=<%# DataBinder.Eval(Container.DataItem, "IDTag") %>'
							class="label_small">
							<%# 
	...
	<table
		...
		<tr>
			<td align="right">
				<input 
					type="button" 
					onclick="javascript:window.location='NWS-NewsTag.aspx';return false;" 
					value="New"
					class="button" />
			</td>
		</tr>
