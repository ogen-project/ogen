<%@ Page 
	...
	CodeBehind="NWS-NewsSource.aspx.cs" 
	Inherits="OGen.NTier.Kick.presentationlayer.weblayer.NWS_NewsSource" 
	...
	<table width="700" border="1" align="center" cellpadding="5" cellspacing="0">
		<tr>
			<td width="700" bgcolor="#DDDDDD">
				<span class="heads_maior">Source</span>
			</td>
		</tr>
	</table>
	<table width="700" border="1" align="center" cellpadding="5" cellspacing="0">
		...
		<tr>
			...
			<td>
				<asol:KickListBox
					ID="ddl_Source_parent" runat="server" 
		...
		<tr style="border-color: #CCCCCC;">
			<td 
				...
				<span class="titulos">
					<input 
						type="button" 
						onclick="javascript:window.location='NWS-NewsSource-list.aspx';return false;" 
						value="Cancel"
