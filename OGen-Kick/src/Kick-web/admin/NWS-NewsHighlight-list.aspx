<%@ Page 
	...
	CodeBehind="NWS-NewsHighlight-list.aspx.cs" 
	Inherits="OGen.NTier.Kick.presentationlayer.weblayer.NWS_NewsHighlight_list" 
		...
		<ItemTemplate>
				<tr>
					<td class="label_small nowrap" style="width: 100%;">
						<a 
							href='NWS-NewsHighlight.aspx?IDHighlight=<%# DataBinder.Eval(Container.DataItem, "IDHighlight") %>'
							class="label_small">
							<%# 
	...
	<table
		...
		<tr>
			<td align="right">
				<input 
					type="button" 
					onclick="javascript:window.location='NWS-NewsHighlight.aspx';return false;" 
					value="New"
					class="button" />
			</td>
		</tr>
